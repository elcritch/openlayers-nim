...
type
  TileGridOptions* = ref object of JsRoot
...
proc `origins=`*(options: TileGridOptions, value: JsObject) {.importjs: "#.origins = #".}
proc `origins=`*(options: TileGridOptions, value: RootRef) {.importjs: "#.origins = #".}
proc `origins=`*[T](options: TileGridOptions, value: seq[T]) {.importjs: "#.origins = #".}
proc `resolutions=`*(options: TileGridOptions, value: seq[float]) {.importjs: "#.resolutions = #".}
...
proc `tileSize=`*(options: TileGridOptions, value: JsObject) {.importjs: "#.tileSize = #".}
proc `tileSize=`*(options: TileGridOptions, value: RootRef) {.importjs: "#.tileSize = #".}
proc `tileSizes=`*(options: TileGridOptions, value: JsObject) {.importjs: "#.tileSizes = #".}
proc `tileSizes=`*(options: TileGridOptions, value: RootRef) {.importjs: "#.tileSizes = #".}
proc `tileSizes=`*[T](options: TileGridOptions, value: seq[T]) {.importjs: "#.tileSizes = #".}

proc newTileGrid*(options: TileGridOptions): TileGrid {.importjs: "(new olNs_tilegrid_TileGrid.default(#))".}
