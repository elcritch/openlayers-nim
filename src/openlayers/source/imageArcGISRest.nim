...
type ImageArcGISRest* = ref object of JsRoot
proc newImageArcGISRest*(
  options: JsObject = jsUndefined
): ImageArcGISRest {.importjs: "(new olNs_source_ImageArcGISRest.default(#))".}

proc getParams*(self: ImageArcGISRest): JsObject {.importjs: "#.getParams()".}
proc getImageLoadFunction*(
  self: ImageArcGISRest
): JsObject {.importjs: "#.getImageLoadFunction()".}

proc getUrl*(self: ImageArcGISRest): cstring {.importjs: "#.getUrl()".}
proc setImageLoadFunction*(
  self: ImageArcGISRest, imageLoadFunction: JsObject
) {.importjs: "#.setImageLoadFunction(#)".}
...
proc updateParams*(
  self: ImageArcGISRest, params: JsObject
) {.importjs: "#.updateParams(#)".}

type ImageArcGISRestOptions* = ref object of JsRoot

proc newImageArcGISRestOptions*(): ImageArcGISRestOptions {.importjs: "({})".}
proc `attributions=`*(
  options: ImageArcGISRestOptions, value: JsObject
) {.importjs: "#.attributions = #".}

proc `attributions=`*(
  options: ImageArcGISRestOptions, value: RootRef
) {.importjs: "#.attributions = #".}

proc `crossOrigin=`*(
  options: ImageArcGISRestOptions, value: cstring
...
proc `interpolate=`*(
  options: ImageArcGISRestOptions, value: bool
...
proc `ratio=`*(
  options: ImageArcGISRestOptions, value: float
) {.importjs: "#.ratio = #".}

proc `resolutions=`*(
  options: ImageArcGISRestOptions, value: seq[float]
) {.importjs: "#.resolutions = #".}

proc `url=`*(options: ImageArcGISRestOptions, value: cstring) {.importjs: "#.url = #".}

proc newImageArcGISRest*(
  options: ImageArcGISRestOptions
): ImageArcGISRest {.importjs: "(new olNs_source_ImageArcGISRest.default(#))".}
