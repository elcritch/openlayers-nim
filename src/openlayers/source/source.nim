...
type Source* = ref object of JsRoot
proc newSource*(): Source {.importjs: "(new olNs_source_Source.default())".}

type SourceOptions* = ref object of JsRoot

proc newSourceOptions*(): SourceOptions {.importjs: "({})".}
proc `attributions=`*(
  options: SourceOptions, value: JsObject
) {.importjs: "#.attributions = #".}

proc `attributions=`*(
  options: SourceOptions, value: RootRef
) {.importjs: "#.attributions = #".}

proc `attributionsCollapsible=`*(
  options: SourceOptions, value: bool
...
): Source {.importjs: "(new olNs_source_Source.default(#))".}
