...
proc `url=`*(
  options: ImageTileSourceOptions, value: seq[cstring]
) {.importjs: "#.url = #".}

proc `url=`*(options: ImageTileSourceOptions, value: JsObject) {.importjs: "#.url = #".}
proc `loader=`*(
  options: ImageTileSourceOptions, value: JsObject
) {.importjs: "#.loader = #".}
...
proc `attributions=`*(
  options: ImageTileSourceOptions, value: cstring
) {.importjs: "#.attributions = #".}
...
proc `attributionsCollapsible=`*(
  options: ImageTileSourceOptions, value: bool
) {.importjs: "#.attributionsCollapsible = #".}

proc `maxZoom=`*(
  options: ImageTileSourceOptions, value: float
) {.importjs: "#.maxZoom = #".}
...
proc newImageTileSource*(
  options: JsObject = jsUndefined
): ImageTileSource {.importjs: "(new olNs_source_ImageTile.default(#))".}

proc newImageTileSource*(
  options: ImageTileSourceOptions
): ImageTileSource {.importjs: "(new olNs_source_ImageTile.default(#))".}
