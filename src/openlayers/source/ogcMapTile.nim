...
type OGCMapTile* = ref object of JsRoot
proc newOGCMapTile*(
  options: JsObject
): OGCMapTile {.importjs: "(new olNs_source_OGCMapTile.default(#))".}

type OGCMapTileOptions* = ref object of JsRoot

proc newOGCMapTileOptions*(): OGCMapTileOptions {.importjs: "({})".}
proc `url=`*(options: OGCMapTileOptions, value: cstring) {.importjs: "#.url = #".}
proc `context=`*(
  options: OGCMapTileOptions, value: JsObject
) {.importjs: "#.context = #".}

proc `context=`*(
  options: OGCMapTileOptions, value: RootRef
) {.importjs: "#.context = #".}

proc `mediaType=`*(
  options: OGCMapTileOptions, value: cstring
) {.importjs: "#.mediaType = #".}
...
proc `cacheSize=`*(
  options: OGCMapTileOptions, value: float
) {.importjs: "#.cacheSize = #".}
...
proc `interpolate=`*(
  options: OGCMapTileOptions, value: bool
...
proc `collections=`*(
  options: OGCMapTileOptions, value: seq[cstring]
) {.importjs: "#.collections = #".}

proc newOGCMapTile*(
  options: OGCMapTileOptions
): OGCMapTile {.importjs: "(new olNs_source_OGCMapTile.default(#))".}
