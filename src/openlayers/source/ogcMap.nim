...
type OGCMap* = ref object of JsRoot
proc newOGCMap*(
  options: JsObject = jsUndefined
): OGCMap {.importjs: "(new olNs_source_OGCMap.default(#))".}
...
proc setImageLoadFunction*(
  self: OGCMap, imageLoadFunction: JsObject
...
type OGCMapOptions* = ref object of JsRoot

proc newOGCMapOptions*(): OGCMapOptions {.importjs: "({})".}
proc `attributions=`*(
  options: OGCMapOptions, value: JsObject
) {.importjs: "#.attributions = #".}

proc `attributions=`*(
  options: OGCMapOptions, value: RootRef
) {.importjs: "#.attributions = #".}

proc `crossOrigin=`*(
  options: OGCMapOptions, value: cstring
...
proc `interpolate=`*(
  options: OGCMapOptions, value: bool
