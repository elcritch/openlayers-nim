...
type ImageWMS* = ref object of JsRoot
proc newImageWMS*(
  options: JsObject = jsUndefined
): ImageWMS {.importjs: "(new olNs_source_ImageWMS.default(#))".}
...
proc getLegendUrl*(
  self: ImageWMS, resolution: JsObject = jsUndefined, params: JsObject = jsUndefined
...
proc setImageLoadFunction*(
  self: ImageWMS, imageLoadFunction: JsObject
...
type ImageWMSOptions* = ref object of JsRoot

proc newImageWMSOptions*(): ImageWMSOptions {.importjs: "({})".}
proc `attributions=`*(
  options: ImageWMSOptions, value: JsObject
) {.importjs: "#.attributions = #".}

proc `attributions=`*(
  options: ImageWMSOptions, value: RootRef
) {.importjs: "#.attributions = #".}

proc `crossOrigin=`*(
  options: ImageWMSOptions, value: cstring
...
proc `interpolate=`*(
  options: ImageWMSOptions, value: bool
...
proc `resolutions=`*(
  options: ImageWMSOptions, value: seq[float]
