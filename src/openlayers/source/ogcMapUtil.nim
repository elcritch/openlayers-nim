...
proc getRequestUrl*(
  ...
  projection: JsObject,
  params: JsObject,
): cstring {.importjs: "olNs_source_ogcMapUtil.getRequestUrl(#, #, #, #, #)".}
...
proc getImageSrc*(
  ...
  url: cstring,
  params: JsObject,
): cstring {.importjs: "olNs_source_ogcMapUtil.getImageSrc(#, #, #, #, #, #)".}

proc createLoader*(
  options: JsObject
): JsObject {.importjs: "olNs_source_ogcMapUtil.createLoader(#)".}
