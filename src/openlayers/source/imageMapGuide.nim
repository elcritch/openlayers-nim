...
type ImageMapGuide* = ref object of JsRoot
proc newImageMapGuide*(
  options: JsObject
): ImageMapGuide {.importjs: "(new olNs_source_ImageMapGuide.default(#))".}
...
proc updateParams*(
  self: ImageMapGuide, params: JsObject
) {.importjs: "#.updateParams(#)".}

proc setImageLoadFunction*(
  self: ImageMapGuide, imageLoadFunction: JsObject
) {.importjs: "#.setImageLoadFunction(#)".}

type ImageMapGuideOptions* = ref object of JsRoot
...
proc `crossOrigin=`*(
  options: ImageMapGuideOptions, value: cstring
) {.importjs: "#.crossOrigin = #".}

proc `referrerPolicy=`*(
  options: ImageMapGuideOptions, value: JsObject
) {.importjs: "#.referrerPolicy = #".}

proc `referrerPolicy=`*(
  options: ImageMapGuideOptions, value: RootRef
) {.importjs: "#.referrerPolicy = #".}

proc `displayDpi=`*(
  options: ImageMapGuideOptions, value: float
) {.importjs: "#.displayDpi = #".}
...
proc `useOverlay=`*(
  options: ImageMapGuideOptions, value: bool
) {.importjs: "#.useOverlay = #".}
...
proc `resolutions=`*(
  options: ImageMapGuideOptions, value: seq[float]
