...
type
  WMTSOptions* = ref object of JsRoot

proc newWMTSOptions*(): WMTSOptions {.importjs: "({})".}
proc `attributions=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: WMTSOptions, value: cstring) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: WMTSOptions, value: seq[cstring]) {.importjs: "#.attributions = #".}
proc `attributionsCollapsible=`*(options: WMTSOptions, value: bool) {.importjs: "#.attributionsCollapsible = #".}
...
proc `projection=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.projection = #".}
proc `projection=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.projection = #".}
proc `reprojectionErrorThreshold=`*(options: WMTSOptions, value: float) {.importjs: "#.reprojectionErrorThreshold = #".}
proc `requestEncoding=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.requestEncoding = #".}
proc `requestEncoding=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.requestEncoding = #".}
proc `layer=`*(options: WMTSOptions, value: cstring) {.importjs: "#.layer = #".}
proc `style=`*(options: WMTSOptions, value: cstring) {.importjs: "#.style = #".}
proc `tileClass=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.tileClass = #".}
proc `tileClass=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.tileClass = #".}
proc `tilePixelRatio=`*(options: WMTSOptions, value: float) {.importjs: "#.tilePixelRatio = #".}
...
proc `dimensions=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.dimensions = #".}
proc `dimensions=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.dimensions = #".}
proc `url=`*(options: WMTSOptions, value: cstring) {.importjs: "#.url = #".}
proc `tileLoadFunction=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.tileLoadFunction = #".}
proc `tileLoadFunction=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.tileLoadFunction = #".}
...
proc `zDirection=`*(options: WMTSOptions, value: JsObject) {.importjs: "#.zDirection = #".}
proc `zDirection=`*(options: WMTSOptions, value: RootRef) {.importjs: "#.zDirection = #".}

proc newWMTS*(options: WMTSOptions): WMTS {.importjs: "(new olNs_source_WMTS.default(#))".}
