...
type
  StaticOptions* = ref object of JsRoot

proc newStaticOptions*(): StaticOptions {.importjs: "({})".}
proc `attributions=`*(options: StaticOptions, value: JsObject) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: StaticOptions, value: RootRef) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: StaticOptions, value: cstring) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: StaticOptions, value: seq[cstring]) {.importjs: "#.attributions = #".}
...
proc `imageLoadFunction=`*(options: StaticOptions, value: RootRef) {.importjs: "#.imageLoadFunction = #".}
proc `interpolate=`*(options: StaticOptions, value: bool) {.importjs: "#.interpolate = #".}
proc `projection=`*(options: StaticOptions, value: JsObject) {.importjs: "#.projection = #".}
proc `projection=`*(options: StaticOptions, value: RootRef) {.importjs: "#.projection = #".}
proc `url=`*(options: StaticOptions, value: cstring) {.importjs: "#.url = #".}

proc newStatic*(options: StaticOptions): Static {.importjs: "(new olNs_source_ImageStatic.default(#))".}
