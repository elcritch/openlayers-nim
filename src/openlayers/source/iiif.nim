...
type
  IIIFOptions* = ref object of JsRoot

proc newIIIFOptions*(): IIIFOptions {.importjs: "({})".}
proc `attributions=`*(options: IIIFOptions, value: JsObject) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: IIIFOptions, value: RootRef) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: IIIFOptions, value: cstring) {.importjs: "#.attributions = #".}
proc `attributions=`*(options: IIIFOptions, value: seq[cstring]) {.importjs: "#.attributions = #".}
proc `attributionsCollapsible=`*(options: IIIFOptions, value: bool) {.importjs: "#.attributionsCollapsible = #".}
proc `cacheSize=`*(options: IIIFOptions, value: float) {.importjs: "#.cacheSize = #".}
proc `crossOrigin=`*(options: IIIFOptions, value: cstring) {.importjs: "#.crossOrigin = #".}
...
proc `interpolate=`*(options: IIIFOptions, value: bool) {.importjs: "#.interpolate = #".}
proc `projection=`*(options: IIIFOptions, value: JsObject) {.importjs: "#.projection = #".}
proc `projection=`*(options: IIIFOptions, value: RootRef) {.importjs: "#.projection = #".}
proc `quality=`*(options: IIIFOptions, value: cstring) {.importjs: "#.quality = #".}
proc `reprojectionErrorThreshold=`*(options: IIIFOptions, value: float) {.importjs: "#.reprojectionErrorThreshold = #".}
proc `resolutions=`*(options: IIIFOptions, value: seq[float]) {.importjs: "#.resolutions = #".}
...
proc `supports=`*(options: IIIFOptions, value: seq[cstring]) {.importjs: "#.supports = #".}
proc `tilePixelRatio=`*(options: IIIFOptions, value: float) {.importjs: "#.tilePixelRatio = #".}
...
proc `zDirection=`*(options: IIIFOptions, value: JsObject) {.importjs: "#.zDirection = #".}
proc `zDirection=`*(options: IIIFOptions, value: RootRef) {.importjs: "#.zDirection = #".}

proc newIIIF*(options: IIIFOptions): IIIF {.importjs: "(new olNs_source_IIIF.default(#))".}
