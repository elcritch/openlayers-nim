...
type TileDebug* = ref object of JsRoot
proc newTileDebug*(
  options: JsObject = jsUndefined
): TileDebug {.importjs: "(new olNs_source_TileDebug.default(#))".}

type TileDebugOptions* = ref object of JsRoot

proc newTileDebugOptions*(): TileDebugOptions {.importjs: "({})".}
proc `projection=`*(
  options: TileDebugOptions, value: JsObject
) {.importjs: "#.projection = #".}

proc `projection=`*(
  options: TileDebugOptions, value: RootRef
) {.importjs: "#.projection = #".}
...
proc `zDirection=`*(
  options: TileDebugOptions, value: float
) {.importjs: "#.zDirection = #".}
