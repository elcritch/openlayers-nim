...
type
  LayoutOptions* = ref object of JsRoot
...
type
  GPXOptions* = ref object of JsRoot

proc newGPXOptions*(): GPXOptions {.importjs: "({})".}
proc `readExtensions=`*(options: GPXOptions, value: JsObject) {.importjs: "#.readExtensions = #".}
proc `readExtensions=`*(options: GPXOptions, value: RootRef) {.importjs: "#.readExtensions = #".}
