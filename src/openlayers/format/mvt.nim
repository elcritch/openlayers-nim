...
type
  MVTOptions* = ref object of JsRoot

proc newMVTOptions*(): MVTOptions {.importjs: "({})".}
proc `featureClass=`*(options: MVTOptions, value: JsObject) {.importjs: "#.featureClass = #".}
proc `featureClass=`*(options: MVTOptions, value: RootRef) {.importjs: "#.featureClass = #".}
proc `geometryName=`*(options: MVTOptions, value: cstring) {.importjs: "#.geometryName = #".}
...
proc `idProperty=`*(options: MVTOptions, value: cstring) {.importjs: "#.idProperty = #".}
