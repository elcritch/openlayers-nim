...
type
  ProjectionOptions* = ref object of JsRoot
...
proc `extent=`*(options: ProjectionOptions, value: JsObject) {.importjs: "#.extent = #".}
proc `extent=`*(options: ProjectionOptions, value: RootRef) {.importjs: "#.extent = #".}
proc `axisOrientation=`*(options: ProjectionOptions, value: cstring) {.importjs: "#.axisOrientation = #".}
proc `global=`*(options: ProjectionOptions, value: bool) {.importjs: "#.global = #".}
proc `metersPerUnit=`*(options: ProjectionOptions, value: float) {.importjs: "#.metersPerUnit = #".}
proc `worldExtent=`*(options: ProjectionOptions, value: JsObject) {.importjs: "#.worldExtent = #".}
proc `worldExtent=`*(options: ProjectionOptions, value: RootRef) {.importjs: "#.worldExtent = #".}
proc `getPointResolution=`*(options: ProjectionOptions, value: JsObject) {.importjs: "#.getPointResolution = #".}
proc `getPointResolution=`*(options: ProjectionOptions, value: RootRef) {.importjs: "#.getPointResolution = #".}

proc newProjection*(options: ProjectionOptions): Projection {.importjs: "(new olNs_proj_Projection.default(#))".}
