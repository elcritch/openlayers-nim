...
type Icon* = ref object of JsRoot
proc newIcon*(
  options: JsObject = jsUndefined
): Icon {.importjs: "(new olNs_style_Icon.default(#))".}
...
type IconOptions* = ref object of JsRoot

proc newIconOptions*(): IconOptions {.importjs: "({})".}
proc `anchor=`*(options: IconOptions, value: seq[float]) {.importjs: "#.anchor = #".}
proc `anchorOrigin=`*(
  options: IconOptions, value: JsObject
) {.importjs: "#.anchorOrigin = #".}

proc `anchorOrigin=`*(
  options: IconOptions, value: RootRef
) {.importjs: "#.anchorOrigin = #".}

proc `anchorXUnits=`*(
  options: IconOptions, value: JsObject
) {.importjs: "#.anchorXUnits = #".}
...
proc `crossOrigin=`*(
  options: IconOptions, value: cstring
...
proc `displacement=`*(
  options: IconOptions, value: seq[float]
...
proc `rotateWithView=`*(
  options: IconOptions, value: bool
