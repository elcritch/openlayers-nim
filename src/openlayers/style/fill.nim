...
proc newFill*(options: JsObject = jsUndefined): Fill {.importjs: "(new olNs_style_Fill.default(#))".}
...
proc `color=`*(options: FillOptions, value: RootRef) {.importjs: "#.color = #".}
proc `color=`*(options: FillOptions, value: cstring) {.importjs: "#.color = #".}

proc newFill*(options: FillOptions): Fill {.importjs: "(new olNs_style_Fill.default(#))".}
