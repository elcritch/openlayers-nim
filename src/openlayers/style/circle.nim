...
type CircleStyle* = ref object of JsRoot
proc newCircleStyle*(
  options: JsObject = jsUndefined
): CircleStyle {.importjs: "(new olNs_style_Circle.default(#))".}

type CircleStyleOptions* = ref object of JsRoot
...
proc `stroke=`*(
  options: CircleStyleOptions, value: JsObject
) {.importjs: "#.stroke = #".}

proc `stroke=`*(
  options: CircleStyleOptions, value: RootRef
) {.importjs: "#.stroke = #".}

proc `displacement=`*(
  options: CircleStyleOptions, value: seq[float]
...
proc `rotation=`*(
  options: CircleStyleOptions, value: float
) {.importjs: "#.rotation = #".}

proc `rotateWithView=`*(
  options: CircleStyleOptions, value: bool
