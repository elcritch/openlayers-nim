...
type
  ImageStyleOptions* = ref object of JsRoot

proc newImageStyleOptions*(): ImageStyleOptions {.importjs: "({})".}
proc `opacity=`*(options: ImageStyleOptions, value: float) {.importjs: "#.opacity = #".}
proc `rotateWithView=`*(options: ImageStyleOptions, value: bool) {.importjs: "#.rotateWithView = #".}
proc `rotation=`*(options: ImageStyleOptions, value: float) {.importjs: "#.rotation = #".}
...
proc `displacement=`*(options: ImageStyleOptions, value: seq[float]) {.importjs: "#.displacement = #".}
proc `declutterMode=`*(options: ImageStyleOptions, value: JsObject) {.importjs: "#.declutterMode = #".}
proc `declutterMode=`*(options: ImageStyleOptions, value: RootRef) {.importjs: "#.declutterMode = #".}

proc newImageStyle*(options: ImageStyleOptions): ImageStyle {.importjs: "(new olNs_style_Image.default(#))".}
