...
type DataTile* = ref object of JsRoot
proc newDataTile*(
  options: JsObject
): DataTile {.importjs: "(new olNs_DataTile.default(#))".}
...
type DataTileOptions* = ref object of JsRoot

proc newDataTileOptions*(): DataTileOptions {.importjs: "({})".}
proc `tileCoord=`*(
  options: DataTileOptions, value: JsObject
) {.importjs: "#.tileCoord = #".}

proc `tileCoord=`*(
  options: DataTileOptions, value: RootRef
) {.importjs: "#.tileCoord = #".}
...
proc `transition=`*(
  options: DataTileOptions, value: float
) {.importjs: "#.transition = #".}

proc `interpolate=`*(
  options: DataTileOptions, value: bool
