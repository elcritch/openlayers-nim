...
type Zoom* = ref object of JsRoot
proc newZoom*(
  options: JsObject = jsUndefined
): Zoom {.importjs: "(new olNs_control_Zoom.default(#))".}

type ZoomOptions* = ref object of JsRoot
...
proc `zoomInClassName=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomInClassName = #".}

proc `zoomOutClassName=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomOutClassName = #".}

proc `zoomInLabel=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomInLabel = #".}

proc `zoomInLabel=`*(
  options: ZoomOptions, value: JsObject
) {.importjs: "#.zoomInLabel = #".}

proc `zoomInLabel=`*(
  options: ZoomOptions, value: RootRef
) {.importjs: "#.zoomInLabel = #".}

proc `zoomOutLabel=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomOutLabel = #".}
...
proc `zoomInTipLabel=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomInTipLabel = #".}

proc `zoomOutTipLabel=`*(
  options: ZoomOptions, value: cstring
) {.importjs: "#.zoomOutTipLabel = #".}
