...
type
  RotateOptions* = ref object of JsRoot

proc newRotateOptions*(): RotateOptions {.importjs: "({})".}
proc `className=`*(options: RotateOptions, value: cstring) {.importjs: "#.className = #".}
...
proc `compassClassName=`*(options: RotateOptions, value: cstring) {.importjs: "#.compassClassName = #".}
...
proc `resetNorth=`*(options: RotateOptions, value: JsObject) {.importjs: "#.resetNorth = #".}
proc `resetNorth=`*(options: RotateOptions, value: RootRef) {.importjs: "#.resetNorth = #".}
...
proc newRotate*(options: RotateOptions): Rotate {.importjs: "(new olNs_control_Rotate.default(#))".}
