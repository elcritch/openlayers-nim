...
proc getWORKER_OFFSCREEN_CANVAS*(): bool {.importjs: "(olNs_has.WORKER_OFFSCREEN_CANVAS)".}
...
proc getPASSIVE_EVENT_LISTENERS*(): bool {.importjs: "(olNs_has.PASSIVE_EVENT_LISTENERS)".}
