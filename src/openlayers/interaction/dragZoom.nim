...
type
  DragZoomOptions* = ref object of JsRoot

proc newDragZoomOptions*(): DragZoomOptions {.importjs: "({})".}
proc `className=`*(options: DragZoomOptions, value: cstring) {.importjs: "#.className = #".}
proc `condition=`*(options: DragZoomOptions, value: JsObject) {.importjs: "#.condition = #".}
proc `condition=`*(options: DragZoomOptions, value: RootRef) {.importjs: "#.condition = #".}
...
proc newDragZoom*(options: DragZoomOptions): DragZoom {.importjs: "(new olNs_interaction_DragZoom.default(#))".}
