...
type
  TranslateOptions* = ref object of JsRoot

proc newTranslateOptions*(): TranslateOptions {.importjs: "({})".}
proc `condition=`*(options: TranslateOptions, value: JsObject) {.importjs: "#.condition = #".}
proc `condition=`*(options: TranslateOptions, value: RootRef) {.importjs: "#.condition = #".}
proc `features=`*(options: TranslateOptions, value: JsObject) {.importjs: "#.features = #".}
proc `features=`*(options: TranslateOptions, value: RootRef) {.importjs: "#.features = #".}
...
proc `layers=`*[T](options: TranslateOptions, value: seq[T]) {.importjs: "#.layers = #".}
...
proc `hitTolerance=`*(options: TranslateOptions, value: float) {.importjs: "#.hitTolerance = #".}

proc newTranslate*(options: TranslateOptions): Translate {.importjs: "(new olNs_interaction_Translate.default(#))".}
