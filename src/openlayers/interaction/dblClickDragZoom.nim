...
type
  DblClickDragZoomOptions* = ref object of JsRoot

proc newDblClickDragZoomOptions*(): DblClickDragZoomOptions {.importjs: "({})".}
proc `duration=`*(options: DblClickDragZoomOptions, value: float) {.importjs: "#.duration = #".}
proc `delta=`*(options: DblClickDragZoomOptions, value: float) {.importjs: "#.delta = #".}
proc `stopDown=`*(options: DblClickDragZoomOptions, value: JsObject) {.importjs: "#.stopDown = #".}
proc `stopDown=`*(options: DblClickDragZoomOptions, value: RootRef) {.importjs: "#.stopDown = #".}

proc newDblClickDragZoom*(options: DblClickDragZoomOptions): DblClickDragZoom {.importjs: "(new olNs_interaction_DblClickDragZoom.default(#))".}
