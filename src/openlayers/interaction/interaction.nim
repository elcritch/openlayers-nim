...
type
  InteractionOptions* = ref object of JsRoot

proc newInteractionOptions*(): InteractionOptions {.importjs: "({})".}
proc `handleEvent=`*(options: InteractionOptions, value: JsObject) {.importjs: "#.handleEvent = #".}
proc `handleEvent=`*(options: InteractionOptions, value: RootRef) {.importjs: "#.handleEvent = #".}

proc newInteraction*(options: InteractionOptions): Interaction {.importjs: "(new olNs_interaction_Interaction.default(#))".}
