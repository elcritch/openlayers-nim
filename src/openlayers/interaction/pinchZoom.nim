...
type
  PinchZoomOptions* = ref object of JsRoot

proc newPinchZoomOptions*(): PinchZoomOptions {.importjs: "({})".}
proc `duration=`*(options: PinchZoomOptions, value: float) {.importjs: "#.duration = #".}

proc newPinchZoom*(options: PinchZoomOptions): PinchZoom {.importjs: "(new olNs_interaction_PinchZoom.default(#))".}
