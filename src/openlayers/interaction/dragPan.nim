...
type
  DragPanOptions* = ref object of JsRoot

proc newDragPanOptions*(): DragPanOptions {.importjs: "({})".}
proc `condition=`*(options: DragPanOptions, value: JsObject) {.importjs: "#.condition = #".}
proc `condition=`*(options: DragPanOptions, value: RootRef) {.importjs: "#.condition = #".}
proc `onFocusOnly=`*(options: DragPanOptions, value: bool) {.importjs: "#.onFocusOnly = #".}
...
proc newDragPan*(options: DragPanOptions): DragPan {.importjs: "(new olNs_interaction_DragPan.default(#))".}
