...
type
  ModifyOptions* = ref object of JsRoot

proc newModifyOptions*(): ModifyOptions {.importjs: "({})".}
proc `condition=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.condition = #".}
proc `condition=`*(options: ModifyOptions, value: RootRef) {.importjs: "#.condition = #".}
proc `deleteCondition=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.deleteCondition = #".}
proc `deleteCondition=`*(options: ModifyOptions, value: RootRef) {.importjs: "#.deleteCondition = #".}
proc `insertVertexCondition=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.insertVertexCondition = #".}
proc `insertVertexCondition=`*(options: ModifyOptions, value: RootRef) {.importjs: "#.insertVertexCondition = #".}
proc `pixelTolerance=`*(options: ModifyOptions, value: float) {.importjs: "#.pixelTolerance = #".}
...
proc `hitDetection=`*(options: ModifyOptions, value: bool) {.importjs: "#.hitDetection = #".}
proc `hitDetection=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.hitDetection = #".}
proc `hitDetection=`*(options: ModifyOptions, value: RootRef) {.importjs: "#.hitDetection = #".}
proc `features=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.features = #".}
...
proc `traceSource=`*(options: ModifyOptions, value: JsObject) {.importjs: "#.traceSource = #".}
proc `traceSource=`*(options: ModifyOptions, value: RootRef) {.importjs: "#.traceSource = #".}
proc `wrapX=`*(options: ModifyOptions, value: bool) {.importjs: "#.wrapX = #".}
proc `snapToPointer=`*(options: ModifyOptions, value: bool) {.importjs: "#.snapToPointer = #".}

proc newModify*(options: ModifyOptions): Modify {.importjs: "(new olNs_interaction_Modify.default(#))".}
