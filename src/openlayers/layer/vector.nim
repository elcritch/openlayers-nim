...
type VectorLayer* = ref object of JsRoot
proc newVectorLayer*(
  options: JsObject = jsUndefined
): VectorLayer {.importjs: "(new olNs_layer_Vector.default(#))".}

type VectorLayerOptions* = ref object of JsRoot
...
proc `style=`*(
  options: VectorLayerOptions, value: proc(feature: JsObject): JsObject
) {.importjs: "#.style = #".}

proc `style=`*(
  options: VectorLayerOptions,
  value: proc(feature: JsObject, resolution: float): JsObject,
) {.importjs: "#.style = #".}
