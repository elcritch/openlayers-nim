...
proc `minResolution=`*(
  options: GraticuleOptions, value: float
...
proc `strokeStyle=`*(
  options: GraticuleOptions, value: JsObject
) {.importjs: "#.strokeStyle = #".}

proc `strokeStyle=`*(
  options: GraticuleOptions, value: RootRef
) {.importjs: "#.strokeStyle = #".}
...
proc `showLabels=`*(
  options: GraticuleOptions, value: bool
) {.importjs: "#.showLabels = #".}

proc `lonLabelFormatter=`*(
  options: GraticuleOptions, value: JsObject
) {.importjs: "#.lonLabelFormatter = #".}

proc `lonLabelFormatter=`*(
  options: GraticuleOptions, value: RootRef
) {.importjs: "#.lonLabelFormatter = #".}

proc `latLabelFormatter=`*(
  options: GraticuleOptions, value: JsObject
) {.importjs: "#.latLabelFormatter = #".}

proc `latLabelFormatter=`*(
  options: GraticuleOptions, value: RootRef
) {.importjs: "#.latLabelFormatter = #".}

proc `lonLabelPosition=`*(
  options: GraticuleOptions, value: float
) {.importjs: "#.lonLabelPosition = #".}

proc `latLabelPosition=`*(
  options: GraticuleOptions, value: float
) {.importjs: "#.latLabelPosition = #".}

proc `lonLabelStyle=`*(
  options: GraticuleOptions, value: JsObject
) {.importjs: "#.lonLabelStyle = #".}
...
proc `intervals=`*(
  options: GraticuleOptions, value: seq[float]
) {.importjs: "#.intervals = #".}
...
): Graticule {.importjs: "(new olNs_layer_Graticule.default(#))".}
