...
type
  HeatmapOptions* = ref object of JsRoot

proc newHeatmapOptions*(): HeatmapOptions {.importjs: "({})".}
proc `className=`*(options: HeatmapOptions, value: cstring) {.importjs: "#.className = #".}
...
proc `minResolution=`*(options: HeatmapOptions, value: float) {.importjs: "#.minResolution = #".}
proc `maxResolution=`*(options: HeatmapOptions, value: float) {.importjs: "#.maxResolution = #".}
...
proc `gradient=`*(options: HeatmapOptions, value: seq[cstring]) {.importjs: "#.gradient = #".}
...
proc `variables=`*(options: HeatmapOptions, value: JsObject) {.importjs: "#.variables = #".}
proc `variables=`*(options: HeatmapOptions, value: RootRef) {.importjs: "#.variables = #".}
proc `variables=`*[T](options: HeatmapOptions, value: seq[T]) {.importjs: "#.variables = #".}
...
proc `properties=`*(options: HeatmapOptions, value: JsObject) {.importjs: "#.properties = #".}
proc `properties=`*(options: HeatmapOptions, value: RootRef) {.importjs: "#.properties = #".}

proc newHeatmap*(options: HeatmapOptions): Heatmap {.importjs: "(new olNs_layer_Heatmap.default(#))".}
